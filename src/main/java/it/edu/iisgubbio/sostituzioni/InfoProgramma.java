...
public class InfoProgramma{
	private String[] sviluppatori = {"Edoardo Panfili","Claudio Giammarioli",
			"Michele Bellucci", // 2025-26
			"Diego Mariucci",   // 2023-24
			"Luzi Davide","Andrei Riginel Ungureanu","Flavio Merli","Omar Mohamed Nasr", // 2021-22
			"Angeloni Pietro","Battistoni Giulia","Bejdo Loris","Biagiotti Luca",
